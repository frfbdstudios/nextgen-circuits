...
export function AddCategoryGroupDialog({ isOpen, onClose, onSuccess }: AddCategoryGroupDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!userIsAdmin) {
        toast.error('Only admins can create category groups')
        return
      }
      ...
      toast.error(error.message || 'Failed to create category group')
    } finally {
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-hidden">
        <DialogHeader>
          ...
          <DialogDescription>
            Group multiple categories together for better organization
          </DialogDescription>
        </DialogHeader>
